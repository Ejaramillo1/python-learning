...
#prints the first state in the list
print(states_of_america[0])

dirty_dozen = ["Strawberries", "Spinach", "Kale", "Nectarines", "Apples", "Grapes", "Peaches", "Cherries", "Pears", "Tomatoes", "Celery", "Potatoes"]

# Shows how to append an element to a list

states_of_america.append("Angelaland")

# Prints the new element that was appended to the list
print(states_of_america)

# Extends the list
states_of_america.extend(["Laloland", "Olgalandia"])

# prints the new extended list
